    ...
    >
      ...
      <div className="w-screen relative h-[500px] sm:h-[600px] overflow-hidden mb-10">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full text-center text-white px-4">
          ...
          >
            <span>Explore Products</span> <span className="text-xl">↓</span>
          </motion.button>
        </div>
      </div>
      ...
      >
        ...
        <p className="max-w-2xl mx-auto text-gray-700">
          Uma Dairy एक प्रयास है ग्रामीण भारत के पारंपरिक और शुद्ध उत्पादों को हर घर तक पहुँचाने का।
          हमारे उत्पाद देशी गायों के दूध और प्राकृतिक संसाधनों से बनाए जाते हैं, जो आपके स्वास्थ्य और
          परंपरा दोनों का ध्यान रखते हैं।
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {['घी बहुत स्वादिष्ट है।', 'छाछ पीकर ठंडक मिलती है।', 'गोबर के उपले पूजा के लिए बढ़िया हैं।'].map(
            (review, i) => (
              <motion.div
                key={i}
                className="bg-white shadow-md p-4 rounded-lg border hover:shadow-lg"
      ...
      <motion.div
        className="mt-28 text-center px-4 py-12 bg-yellow-100 rounded-xl shadow-inner"
